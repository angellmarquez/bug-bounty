    ...
    public function create(Request $request): InertiaResponse
    {
        ...
        return Inertia::render('reportes/Create', [
            'programas' => $programas->map(fn ($p) => [
                'id' => $p->id,
                'nombre' => $p->empresa ? "{$p->nombre} (".($p->empresa->nombre_comercial ?? $p->empresa->razon_social).')' : $p->nombre,
                'slug' => $p->slug,
                'poc_schema' => $p->poc_schema,
            ]),
            'programaInicial' => $programaInicial ? [
                'id' => $programaInicial->id,
                'nombre' => $programaInicial->empresa ? "{$programaInicial->nombre} (".($programaInicial->empresa->nombre_comercial ?? $programaInicial->empresa->razon_social).')' : $programaInicial->nombre,

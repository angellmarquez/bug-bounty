...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------- |
| **cvss.ts**          | Función `roundUp` genera valores con 1 decimal pero la spec requiere 1 decimal _redondeado_; casos extremos pueden errar | Revisar implementación contra RFC 6390.                 |
...
_Esta auditoría está preparada para ser usada como base de trabajo. Si deseas que integre alguna corrección automáticamente, indícame los archivos específicos y los cambios que deseas aplicar._
